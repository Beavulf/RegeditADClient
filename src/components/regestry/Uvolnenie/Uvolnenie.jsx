...
export default function Uvolnenie() {
    ...
    const columnsUvolnenie = useMemo(()=>
      [
    ...
    const filterInfo = (
      <Box sx={{display:'flex', alignItems:'center', justifyContent:'space-between', bgcolor:'#9c92921d', padding:0.5, borderRadius:'8px', flex:1}}>
